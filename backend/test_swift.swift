...
alarm.setValue(5, forKey: "hour")
alarm.setValue(15, forKey: "minute")
alarm.setValue("Type Test", forKey: "title")
alarm.setValue(true, forKey: "enabled")

// repeatSchedule is an NSUInteger
alarm.setValue(NSNumber(value: UInt(2)), forKey: "repeatSchedule")
